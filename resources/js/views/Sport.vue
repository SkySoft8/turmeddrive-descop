                ...
                <div id="sort" class="sort-items">
                    ...
                    <div class="sort-item">
                        ...
                        <form>
                            <label
                                :class="
                                    districts.indexOf(republic.district_id) !=
                                    -1
                                        ? 'd-block'
                                        : 'd-none'
                                "
                    ...
                    <div class="sort-item">
                        ...
                        <form>
                            <label
                                :key="city.id"
                                :class="
                                    republics.indexOf(city.republic_id) != -1
                                        ? 'd-block'
                                        : 'd-none'
                                "
                                :for="`city` + city.id"
                        ...
                        <div
                            v-if="
                                ...
                                (state.city === '' &&
                                    state.district === '' &&
                                    state.republic === '') ||
                                (cities === sport.city_id &&
                                    districts === sport.district_id &&
                                    republics === sport.republic_id)
                            "
                        >
...
export default {
    ...
    methods: {
        getHostel() {
            this.axios.post("/api/sports", {}).then((res) => {
        ...
        getFilterList() {
            this.axios.get("/api/sports/filters").then((res) => {
