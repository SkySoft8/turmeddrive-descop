        ...
        <div class="row">
            ...
            <div class="sort col col-12 col-md-2">
                ...
                <div id="sort" class="sort-items">
                    ...
                    <button @click.prevent="getFilter()" type="submit">
                        Найти
                    </button>
                </div>
            </div>
                        ...
                        <div
                            v-if="
                                ...
                                (state.city === '' &&
                                    ...
                                    state.republic === '') ||
                                (cities === item.city_id &&
                                    districts === item.district_id &&
                                    republics === item.republic_id)
                            "
                        >
                            <router-link :to="'/spa/' + item.id">
                                ...
                                <div class="list-item-descr">
                                    ...
                                    <p>{{ item.desc }}</p>
                                    <ul>
                                        <li v-for="tag in item.tags" :key="tag.title">
                                            {{ tag.title }}
                                        </li>
                                    </ul>
                                    <div class="company">
...
export default {
    ...
    methods: {
        getSpa() {
            this.axios.post("/api/spa", {}).then((res) => {
        ...
        getFilterList() {
            this.axios.get("/api/spa/filters").then((res) => {
