            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-1 mb-3">
                        <a href="{{route('turoperator.tag.create')}}" class="btn btn-block btn-primary">Добавить</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                                ...
                                <table class="table table-hover text-nowrap">
                                    ...
                                    @foreach($turoperatorTags as $turoperatorTag)
                                        <tr>
                                            ...
                                            <td><a href="{{route('turoperator.tag.edit', $turoperatorTag->id)}}"
                                                   class='text-success'><i class="fas fa-pencil-alt"></i></a></td>
                                            <td>
                                                <form action="{{route('turoperator.tag.delete', $turoperatorTag->id)}}" method="post">
                                                    @csrf
                                                    @method('DELETE')
