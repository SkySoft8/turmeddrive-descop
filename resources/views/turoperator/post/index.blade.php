            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-1 mb-3">
                        <a href="{{route('turoperator.post.create')}}" class="btn btn-block btn-primary">Добавить</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                                ...
                                <table class="table table-hover text-nowrap">
                                    ...
                                    @foreach($turoperatorPosts as $turoperatorPost)
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{route('turoperator.post.delete', $turoperatorPost->id)}}" method="post">
                                                    @csrf
                                                    @method('DELETE')
