            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-1 mb-3">
                        <a href="{{route('cafe.card.create')}}" class="btn btn-block btn-primary">Cоздать</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                                ...
                                <table class="table table-hover text-nowrap">
                                    ...
                                    @foreach($cafeCards as $cafeCard)
                                        <tr>
                                            ...
                                            <td><a href="{{route('cafe.card.edit', $cafeCard->id)}}"
                                                   class='text-success'><i class="fas fa-pencil-alt"></i></a></td>
                                            <td>
                                                <form action="{{route('cafe.card.delete', $cafeCard->id)}}" method="post">
                                                    @csrf
                                                    @method('DELETE')
