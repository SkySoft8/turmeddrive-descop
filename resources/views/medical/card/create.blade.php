...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <form action="{{route('medical.card.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group w-50">
                            ...
                            <select class="select2" name="medical_tag_ids[]" multiple="multiple"
                                ...
                                @foreach($medicalTags as $medicalTag)
                                    <option
                                            {{is_array(old('$medicalTag_ids')) && in_array($medicalTag->id, old('medicalTag_ids')) ? ' selected' : ''}}
                                            value="{{$medicalTag->id}}">{{$medicalTag->title}}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group w-50">
