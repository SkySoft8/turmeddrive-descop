    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Создать карточку cпортбазы</h1>
                    </div><!-- /.col -->
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <form action="{{route('sport.card.store')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group w-50">
                                ...
                                <select class="select2" name="sport_cardTag_ids[]" multiple="multiple"
                                    ...
                                    @foreach($sportCardTags as $sportCardTag)
                                        <option
                                                {{is_array(old('sport_cardTag_ids')) && in_array($sportCardTag->id, old('sport_cardTag_ids')) ? ' selected' : ''}}
                                                value="{{$sportCardTag->id}}">{{$sportCardTag->title}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group w-50">
